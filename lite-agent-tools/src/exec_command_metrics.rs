...
impl PromExecCommandRecorder {
    ...
    pub fn with_registry_and_labels(
        ...
        let commands = IntCounterVec::new(
            prometheus::Opts::new("lite_agent_exec_commands_total", "Exec command outcomes")
                .const_labels(labels.clone()),
            &["outcome"],
        )?;
        let durations = HistogramVec::new(
            prometheus::HistogramOpts::new(
                "lite_agent_exec_command_duration_seconds",
        ...
        let output_bytes = HistogramVec::new(
            prometheus::HistogramOpts::new(
                "lite_agent_exec_command_output_bytes",
        ...
        let output_truncated = IntCounterVec::new(
            prometheus::Opts::new(
                "lite_agent_exec_command_output_truncated_total",
